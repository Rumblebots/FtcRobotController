...
@Autonomous(name = "AutonBlueInnerShotsFirstDelayed - States", group = "Delayed Autonomous")

public class AutoBlueInnerShotsFirstDelayed extends GenericBlueShotsFirst {
    @Override
